...
const RecipeDetail = (props) => (
    <div style={props.style}>
        ...
        <h3>Steps</h3>
        <ol>
            <li>Preheat oven to 350 degrees F (174 degreec C). Line two 12-cup muffin tins with paper liners, preferabe dark-colored or Halloween-themed ones.</li>
            ...
            <li>Bake in the preheated oven until a toothpick inserted in the center comes out clean, 18 to 21 minutes. Remove from oven and cool tins on a wire rack for 15 minutes.</li>
            <li>Remove cupcakes from the tins and cool completely on a wire rack before decorations, about 1 hour.</li>
            <li>Frost each cupcake with a thin layer of white vanilla frosting and refrigerate for 30 minutes to make decorationg easier.</li>
